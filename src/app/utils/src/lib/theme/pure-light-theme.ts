...
export const PureLightTheme = createTheme({
  ...
  components: {
    MuiBackdrop: {
      styleOverrides: {
        root: {
          backgroundColor: alpha(darken(themeColors.primaryAlt, 0.8), 0.5),
  ...
  typography: {
    fontFamily: ['Plus Jakarta Sans Variable', 'sans-serif'].join(',')
  },
  shadows: [
    'none',
    'none',
    'none',
    '0px 1px 2px rgba(0, 0, 0, 0.08)', // elevation 1
    '0px 2px 4px rgba(0, 0, 0, 0.08)', // elevation 2
    '0px 4px 8px rgba(0, 0, 0, 0.08)', // elevation 3
    '0px 8px 16px rgba(0, 0, 0, 0.08)', // elevation 4
    '0px 16px 24px rgba(0, 0, 0, 0.08)', // elevation 5
    '0px 1px 2px rgba(0, 0, 0, 0.08)', // elevation 1
    '0px 2px 4px rgba(0, 0, 0, 0.08)', // elevation 2
    '0px 4px 8px rgba(0, 0, 0, 0.08)', // elevation 3
    '0px 8px 16px rgba(0, 0, 0, 0.08)', // elevation 4
